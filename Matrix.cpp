...
Matrix4x4 Matrix4x4::Translate(Vector3f translation)
{
	Matrix4x4 result;
...
Matrix4x4 Matrix4x4::Scale(Vector3f scale)
{
	Matrix4x4 result;
...
Matrix4x4 Matrix4x4::LookAt(Vector3f eyePosition, Vector3f lookAtPosition, Vector3f up)
{
...
Vector2f Matrix4x4::MulVec2(Matrix4x4 matrix, Vector2f vector)
{
	Vector2f result;
...
Vector3f Matrix4x4::MulVec3(Matrix4x4 matrix, Vector3f vector)
{
	Vector3f result;
...
Vector2f Matrix4x4::ToVector2f() const
{
	Vector2f result;
...
Vector3f Matrix4x4::ToVector3f() const
{
	Vector3f result;
...
Vector3f Matrix4x4::ExtractTranslation() const
{
	return Vector3f(m[0][3], m[1][3], m[2][3]);
}

Vector3f Matrix4x4::ExtractScale() const
{
	Vector3f result;
